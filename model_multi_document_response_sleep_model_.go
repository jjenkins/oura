...
// checks if the MultiDocumentResponseSleepModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseSleepModel{}

// MultiDocumentResponseSleepModel struct for MultiDocumentResponseSleepModel
type MultiDocumentResponseSleepModel struct {
	Data []SleepModel `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponseSleepModel MultiDocumentResponseSleepModel
...
func NewMultiDocumentResponseSleepModel(data []SleepModel, nextToken NullableString) *MultiDocumentResponseSleepModel {
	this := MultiDocumentResponseSleepModel{}
	this.Data = data
...
func (o MultiDocumentResponseSleepModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseSleepModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseSleepModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseSleepModel := _MultiDocumentResponseSleepModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseSleepModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseSleepModel(varMultiDocumentResponseSleepModel)

	return err
}

type NullableMultiDocumentResponseSleepModel struct {
	value *MultiDocumentResponseSleepModel
	isSet bool
}

func (v NullableMultiDocumentResponseSleepModel) Get() *MultiDocumentResponseSleepModel {
	return v.value
}

func (v *NullableMultiDocumentResponseSleepModel) Set(val *MultiDocumentResponseSleepModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseSleepModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseSleepModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseSleepModel(val *MultiDocumentResponseSleepModel) *NullableMultiDocumentResponseSleepModel {
	return &NullableMultiDocumentResponseSleepModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseSleepModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseSleepModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
