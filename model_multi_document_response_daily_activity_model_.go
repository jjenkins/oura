...
// checks if the MultiDocumentResponseDailyActivityModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseDailyActivityModel{}

// MultiDocumentResponseDailyActivityModel struct for MultiDocumentResponseDailyActivityModel
...
type _MultiDocumentResponseDailyActivityModel MultiDocumentResponseDailyActivityModel
...
func NewMultiDocumentResponseDailyActivityModel(data []DailyActivityModel, nextToken NullableString) *MultiDocumentResponseDailyActivityModel {
	this := MultiDocumentResponseDailyActivityModel{}
	this.Data = data
...
func (o MultiDocumentResponseDailyActivityModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseDailyActivityModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseDailyActivityModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseDailyActivityModel := _MultiDocumentResponseDailyActivityModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseDailyActivityModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseDailyActivityModel(varMultiDocumentResponseDailyActivityModel)

	return err
}

type NullableMultiDocumentResponseDailyActivityModel struct {
	value *MultiDocumentResponseDailyActivityModel
	isSet bool
}

func (v NullableMultiDocumentResponseDailyActivityModel) Get() *MultiDocumentResponseDailyActivityModel {
	return v.value
}

func (v *NullableMultiDocumentResponseDailyActivityModel) Set(val *MultiDocumentResponseDailyActivityModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseDailyActivityModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseDailyActivityModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseDailyActivityModel(val *MultiDocumentResponseDailyActivityModel) *NullableMultiDocumentResponseDailyActivityModel {
	return &NullableMultiDocumentResponseDailyActivityModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseDailyActivityModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseDailyActivityModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
