...
// RingDesign the model 'RingDesign'
type RingDesign string

// List of RingDesign
const (
	BALANCE RingDesign = "balance"
	BALANCE_DIAMOND RingDesign = "balance_diamond"
	HERITAGE RingDesign = "heritage"
	HORIZON RingDesign = "horizon"
)

// All allowed values of RingDesign enum
var AllowedRingDesignEnumValues = []RingDesign{
	"balance",
	"balance_diamond",
	"heritage",
	"horizon",
...
func (v *RingDesign) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := RingDesign(value)
	for _, existing := range AllowedRingDesignEnumValues {
	...
	return fmt.Errorf("%+v is not a valid RingDesign", value)
}

// NewRingDesignFromValue returns a pointer to a valid RingDesign
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewRingDesignFromValue(v string) (*RingDesign, error) {
	ev := RingDesign(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for RingDesign: valid values are %v", v, AllowedRingDesignEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v RingDesign) IsValid() bool {
	for _, existing := range AllowedRingDesignEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to RingDesign value
func (v RingDesign) Ptr() *RingDesign {
	return &v
}

type NullableRingDesign struct {
	value *RingDesign
	isSet bool
}

func (v NullableRingDesign) Get() *RingDesign {
	return v.value
}

func (v *NullableRingDesign) Set(val *RingDesign) {
	v.value = val
	v.isSet = true
}

func (v NullableRingDesign) IsSet() bool {
	return v.isSet
}

func (v *NullableRingDesign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRingDesign(val *RingDesign) *NullableRingDesign {
	return &NullableRingDesign{value: val, isSet: true}
}

func (v NullableRingDesign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRingDesign) UnmarshalJSON(src []byte) error {
	v.isSet = true
