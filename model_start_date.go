...
// StartDate struct for StartDate
...
func (dst *StartDate) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(StartDate)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *StartDate) MarshalJSON() ([]byte, error) {
	if src.String != nil {
