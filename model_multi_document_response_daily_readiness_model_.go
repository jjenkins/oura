...
// checks if the MultiDocumentResponseDailyReadinessModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseDailyReadinessModel{}

// MultiDocumentResponseDailyReadinessModel struct for MultiDocumentResponseDailyReadinessModel
...
type _MultiDocumentResponseDailyReadinessModel MultiDocumentResponseDailyReadinessModel
...
func NewMultiDocumentResponseDailyReadinessModel(data []DailyReadinessModel, nextToken NullableString) *MultiDocumentResponseDailyReadinessModel {
	this := MultiDocumentResponseDailyReadinessModel{}
	this.Data = data
...
func (o MultiDocumentResponseDailyReadinessModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseDailyReadinessModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseDailyReadinessModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseDailyReadinessModel := _MultiDocumentResponseDailyReadinessModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseDailyReadinessModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseDailyReadinessModel(varMultiDocumentResponseDailyReadinessModel)

	return err
}

type NullableMultiDocumentResponseDailyReadinessModel struct {
	value *MultiDocumentResponseDailyReadinessModel
	isSet bool
}

func (v NullableMultiDocumentResponseDailyReadinessModel) Get() *MultiDocumentResponseDailyReadinessModel {
	return v.value
}

func (v *NullableMultiDocumentResponseDailyReadinessModel) Set(val *MultiDocumentResponseDailyReadinessModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseDailyReadinessModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseDailyReadinessModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseDailyReadinessModel(val *MultiDocumentResponseDailyReadinessModel) *NullableMultiDocumentResponseDailyReadinessModel {
	return &NullableMultiDocumentResponseDailyReadinessModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseDailyReadinessModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseDailyReadinessModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
