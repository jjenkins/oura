...
// checks if the MultiDocumentResponseWorkoutModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseWorkoutModel{}

// MultiDocumentResponseWorkoutModel struct for MultiDocumentResponseWorkoutModel
type MultiDocumentResponseWorkoutModel struct {
	Data []WorkoutModel `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponseWorkoutModel MultiDocumentResponseWorkoutModel
...
func NewMultiDocumentResponseWorkoutModel(data []WorkoutModel, nextToken NullableString) *MultiDocumentResponseWorkoutModel {
	this := MultiDocumentResponseWorkoutModel{}
	this.Data = data
...
func (o MultiDocumentResponseWorkoutModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseWorkoutModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseWorkoutModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseWorkoutModel := _MultiDocumentResponseWorkoutModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseWorkoutModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseWorkoutModel(varMultiDocumentResponseWorkoutModel)

	return err
}

type NullableMultiDocumentResponseWorkoutModel struct {
	value *MultiDocumentResponseWorkoutModel
	isSet bool
}

func (v NullableMultiDocumentResponseWorkoutModel) Get() *MultiDocumentResponseWorkoutModel {
	return v.value
}

func (v *NullableMultiDocumentResponseWorkoutModel) Set(val *MultiDocumentResponseWorkoutModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseWorkoutModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseWorkoutModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseWorkoutModel(val *MultiDocumentResponseWorkoutModel) *NullableMultiDocumentResponseWorkoutModel {
	return &NullableMultiDocumentResponseWorkoutModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseWorkoutModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseWorkoutModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
