...
// checks if the MultiDocumentResponseSleepTimeModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseSleepTimeModel{}

// MultiDocumentResponseSleepTimeModel struct for MultiDocumentResponseSleepTimeModel
type MultiDocumentResponseSleepTimeModel struct {
	Data []SleepTimeModel `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponseSleepTimeModel MultiDocumentResponseSleepTimeModel
...
func NewMultiDocumentResponseSleepTimeModel(data []SleepTimeModel, nextToken NullableString) *MultiDocumentResponseSleepTimeModel {
	this := MultiDocumentResponseSleepTimeModel{}
	this.Data = data
...
func (o MultiDocumentResponseSleepTimeModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseSleepTimeModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseSleepTimeModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseSleepTimeModel := _MultiDocumentResponseSleepTimeModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseSleepTimeModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseSleepTimeModel(varMultiDocumentResponseSleepTimeModel)

	return err
}

type NullableMultiDocumentResponseSleepTimeModel struct {
	value *MultiDocumentResponseSleepTimeModel
	isSet bool
}

func (v NullableMultiDocumentResponseSleepTimeModel) Get() *MultiDocumentResponseSleepTimeModel {
	return v.value
}

func (v *NullableMultiDocumentResponseSleepTimeModel) Set(val *MultiDocumentResponseSleepTimeModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseSleepTimeModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseSleepTimeModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseSleepTimeModel(val *MultiDocumentResponseSleepTimeModel) *NullableMultiDocumentResponseSleepTimeModel {
	return &NullableMultiDocumentResponseSleepTimeModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseSleepTimeModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseSleepTimeModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
