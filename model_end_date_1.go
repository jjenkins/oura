...
// EndDate1 struct for EndDate1
type EndDate1 struct {
	String *string
	TimeTime *time.Time
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *EndDate1) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(EndDate1)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *EndDate1) MarshalJSON() ([]byte, error) {
	if src.String != nil {
...
type NullableEndDate1 struct {
	value *EndDate1
	isSet bool
}

func (v NullableEndDate1) Get() *EndDate1 {
	return v.value
}

func (v *NullableEndDate1) Set(val *EndDate1) {
	v.value = val
	v.isSet = true
}

func (v NullableEndDate1) IsSet() bool {
	return v.isSet
}

func (v *NullableEndDate1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndDate1(val *EndDate1) *NullableEndDate1 {
	return &NullableEndDate1{value: val, isSet: true}
}

func (v NullableEndDate1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndDate1) UnmarshalJSON(src []byte) error {
	v.isSet = true
